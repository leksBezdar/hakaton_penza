...
def upgrade() -> None:
    ...
    op.create_table('users',
        ...
        sa.Column('postponed_films', ARRAY(sa.Integer()), nullable=False),
        sa.Column('abondoned_films', ARRAY(sa.Integer()), nullable=False),
        sa.Column('current_films', ARRAY(sa.Integer()), nullable=False),
        sa.Column('finished_films', ARRAY(sa.Integer()), nullable=False),
        sa.Column('favorite_films', ARRAY(sa.Integer()), nullable=False),
